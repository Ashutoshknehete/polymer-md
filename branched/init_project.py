...
length_A = 64
length_B = 64
num_CP = np.arange(32,260,32, dtype=int)
base_CP = [16,32,64] #16 is A16B16, 32 is A32B32, 64 is A64B64 for branched. In linear, it is = #monomers in each block
num_arms = [1,2,4,8]
numblocks = [2,3,5] #for linear
list_architecture = ["mikto","graft","linear"]
                ...
                for N in base_CP:
                    if shape == 'mikto' or shape == 'graft':
                        for n in num_arms:
                            ...
                            "length_B": length_B, "num_CP": M_CP, "length_CP": N_CP, 
